...
From the [earlier physics model]({% post_url 2025-11-17-rederiving-aimpoint %}), we know that for a putt with total rollout $$L = D + R$$, the required initial velocity is:
